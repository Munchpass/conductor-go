...
// checks if the QuickbooksDesktopEstimatesPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopEstimatesPostRequest{}

// QuickbooksDesktopEstimatesPostRequest struct for QuickbooksDesktopEstimatesPostRequest
type QuickbooksDesktopEstimatesPostRequest struct {
	...
	// The estimate's line items, each representing a single product or service quoted.  **IMPORTANT**: You must specify `lines`, `lineGroups`, or both when creating an estimate.
	Lines []QuickbooksDesktopEstimatesPostRequestLinesInner `json:"lines,omitempty"`
	// The estimate's line item groups, each representing a predefined set of related items.  **IMPORTANT**: You must specify `lines`, `lineGroups`, or both when creating an estimate.
	LineGroups []QuickbooksDesktopEstimatesPostRequestLineGroupsInner `json:"lineGroups,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QuickbooksDesktopEstimatesPostRequest QuickbooksDesktopEstimatesPostRequest
...
func NewQuickbooksDesktopEstimatesPostRequest(customerId string, transactionDate string) *QuickbooksDesktopEstimatesPostRequest {
	this := QuickbooksDesktopEstimatesPostRequest{}
...
func (o *QuickbooksDesktopEstimatesPostRequest) GetLines() []QuickbooksDesktopEstimatesPostRequestLinesInner {
	if o == nil || IsNil(o.Lines) {
		var ret []QuickbooksDesktopEstimatesPostRequestLinesInner
		return ret
	}
	return o.Lines
}
...
// SetLines gets a reference to the given []QuickbooksDesktopEstimatesPostRequestLinesInner and assigns it to the Lines field.
...
func (o *QuickbooksDesktopEstimatesPostRequest) GetLineGroups() []QuickbooksDesktopEstimatesPostRequestLineGroupsInner {
	if o == nil || IsNil(o.LineGroups) {
		var ret []QuickbooksDesktopEstimatesPostRequestLineGroupsInner
		return ret
	}
	return o.LineGroups
}
...
// SetLineGroups gets a reference to the given []QuickbooksDesktopEstimatesPostRequestLineGroupsInner and assigns it to the LineGroups field.
func (o *QuickbooksDesktopEstimatesPostRequest) SetLineGroups(v []QuickbooksDesktopEstimatesPostRequestLineGroupsInner) {
	o.LineGroups = v
}

func (o QuickbooksDesktopEstimatesPostRequest) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopEstimatesPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopEstimatesPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopEstimatesPostRequest := _QuickbooksDesktopEstimatesPostRequest{}

	err = json.Unmarshal(data, &varQuickbooksDesktopEstimatesPostRequest)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopEstimatesPostRequest(varQuickbooksDesktopEstimatesPostRequest)
...
type NullableQuickbooksDesktopEstimatesPostRequest struct {
	value *QuickbooksDesktopEstimatesPostRequest
	isSet bool
}

func (v NullableQuickbooksDesktopEstimatesPostRequest) Get() *QuickbooksDesktopEstimatesPostRequest {
	return v.value
}

func (v *NullableQuickbooksDesktopEstimatesPostRequest) Set(val *QuickbooksDesktopEstimatesPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopEstimatesPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopEstimatesPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopEstimatesPostRequest(val *QuickbooksDesktopEstimatesPostRequest) *NullableQuickbooksDesktopEstimatesPostRequest {
	return &NullableQuickbooksDesktopEstimatesPostRequest{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopEstimatesPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopEstimatesPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
