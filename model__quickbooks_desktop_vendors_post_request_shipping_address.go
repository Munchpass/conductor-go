...
// checks if the QuickbooksDesktopVendorsPostRequestShippingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopVendorsPostRequestShippingAddress{}

// QuickbooksDesktopVendorsPostRequestShippingAddress The vendor's shipping address.
type QuickbooksDesktopVendorsPostRequestShippingAddress struct {
...
type _QuickbooksDesktopVendorsPostRequestShippingAddress QuickbooksDesktopVendorsPostRequestShippingAddress
...
func NewQuickbooksDesktopVendorsPostRequestShippingAddress() *QuickbooksDesktopVendorsPostRequestShippingAddress {
	this := QuickbooksDesktopVendorsPostRequestShippingAddress{}
	return &this
}
...
func (o QuickbooksDesktopVendorsPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopVendorsPostRequestShippingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopVendorsPostRequestShippingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopVendorsPostRequestShippingAddress := _QuickbooksDesktopVendorsPostRequestShippingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopVendorsPostRequestShippingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopVendorsPostRequestShippingAddress(varQuickbooksDesktopVendorsPostRequestShippingAddress)
...
type NullableQuickbooksDesktopVendorsPostRequestShippingAddress struct {
	value *QuickbooksDesktopVendorsPostRequestShippingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopVendorsPostRequestShippingAddress) Get() *QuickbooksDesktopVendorsPostRequestShippingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopVendorsPostRequestShippingAddress) Set(val *QuickbooksDesktopVendorsPostRequestShippingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopVendorsPostRequestShippingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopVendorsPostRequestShippingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopVendorsPostRequestShippingAddress(val *QuickbooksDesktopVendorsPostRequestShippingAddress) *NullableQuickbooksDesktopVendorsPostRequestShippingAddress {
	return &NullableQuickbooksDesktopVendorsPostRequestShippingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopVendorsPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopVendorsPostRequestShippingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
