...
// checks if the QuickbooksDesktopEmployeesGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopEmployeesGet200Response{}

// QuickbooksDesktopEmployeesGet200Response struct for QuickbooksDesktopEmployeesGet200Response
type QuickbooksDesktopEmployeesGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of employees.
	Data []QbdEmployee `json:"data"`
...
type _QuickbooksDesktopEmployeesGet200Response QuickbooksDesktopEmployeesGet200Response
...
func NewQuickbooksDesktopEmployeesGet200Response(objectType string, url string, data []QbdEmployee, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopEmployeesGet200Response {
	this := QuickbooksDesktopEmployeesGet200Response{}
...
func (o QuickbooksDesktopEmployeesGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopEmployeesGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopEmployeesGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopEmployeesGet200Response := _QuickbooksDesktopEmployeesGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopEmployeesGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopEmployeesGet200Response(varQuickbooksDesktopEmployeesGet200Response)
...
type NullableQuickbooksDesktopEmployeesGet200Response struct {
	value *QuickbooksDesktopEmployeesGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopEmployeesGet200Response) Get() *QuickbooksDesktopEmployeesGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopEmployeesGet200Response) Set(val *QuickbooksDesktopEmployeesGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopEmployeesGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopEmployeesGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopEmployeesGet200Response(val *QuickbooksDesktopEmployeesGet200Response) *NullableQuickbooksDesktopEmployeesGet200Response {
	return &NullableQuickbooksDesktopEmployeesGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopEmployeesGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopEmployeesGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
