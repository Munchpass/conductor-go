...
// checks if the QuickbooksDesktopBillCreditCardPaymentsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopBillCreditCardPaymentsGet200Response{}

// QuickbooksDesktopBillCreditCardPaymentsGet200Response struct for QuickbooksDesktopBillCreditCardPaymentsGet200Response
type QuickbooksDesktopBillCreditCardPaymentsGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of bill credit card payments.
	Data []QbdBillCreditCardPayment `json:"data"`
...
type _QuickbooksDesktopBillCreditCardPaymentsGet200Response QuickbooksDesktopBillCreditCardPaymentsGet200Response
...
func NewQuickbooksDesktopBillCreditCardPaymentsGet200Response(objectType string, url string, data []QbdBillCreditCardPayment, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopBillCreditCardPaymentsGet200Response {
	this := QuickbooksDesktopBillCreditCardPaymentsGet200Response{}
...
func (o *QuickbooksDesktopBillCreditCardPaymentsGet200Response) GetData() []QbdBillCreditCardPayment {
	if o == nil {
		var ret []QbdBillCreditCardPayment
		return ret
	}
...
func (o QuickbooksDesktopBillCreditCardPaymentsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopBillCreditCardPaymentsGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopBillCreditCardPaymentsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopBillCreditCardPaymentsGet200Response := _QuickbooksDesktopBillCreditCardPaymentsGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopBillCreditCardPaymentsGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopBillCreditCardPaymentsGet200Response(varQuickbooksDesktopBillCreditCardPaymentsGet200Response)
...
type NullableQuickbooksDesktopBillCreditCardPaymentsGet200Response struct {
	value *QuickbooksDesktopBillCreditCardPaymentsGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopBillCreditCardPaymentsGet200Response) Get() *QuickbooksDesktopBillCreditCardPaymentsGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopBillCreditCardPaymentsGet200Response) Set(val *QuickbooksDesktopBillCreditCardPaymentsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopBillCreditCardPaymentsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopBillCreditCardPaymentsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopBillCreditCardPaymentsGet200Response(val *QuickbooksDesktopBillCreditCardPaymentsGet200Response) *NullableQuickbooksDesktopBillCreditCardPaymentsGet200Response {
	return &NullableQuickbooksDesktopBillCreditCardPaymentsGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopBillCreditCardPaymentsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopBillCreditCardPaymentsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
