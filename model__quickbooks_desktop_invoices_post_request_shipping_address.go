...
// checks if the QuickbooksDesktopInvoicesPostRequestShippingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopInvoicesPostRequestShippingAddress{}

// QuickbooksDesktopInvoicesPostRequestShippingAddress The invoice's shipping address.
type QuickbooksDesktopInvoicesPostRequestShippingAddress struct {
...
type _QuickbooksDesktopInvoicesPostRequestShippingAddress QuickbooksDesktopInvoicesPostRequestShippingAddress
...
func NewQuickbooksDesktopInvoicesPostRequestShippingAddress() *QuickbooksDesktopInvoicesPostRequestShippingAddress {
	this := QuickbooksDesktopInvoicesPostRequestShippingAddress{}
	return &this
}
...
func (o QuickbooksDesktopInvoicesPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopInvoicesPostRequestShippingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopInvoicesPostRequestShippingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopInvoicesPostRequestShippingAddress := _QuickbooksDesktopInvoicesPostRequestShippingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopInvoicesPostRequestShippingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopInvoicesPostRequestShippingAddress(varQuickbooksDesktopInvoicesPostRequestShippingAddress)
...
type NullableQuickbooksDesktopInvoicesPostRequestShippingAddress struct {
	value *QuickbooksDesktopInvoicesPostRequestShippingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopInvoicesPostRequestShippingAddress) Get() *QuickbooksDesktopInvoicesPostRequestShippingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopInvoicesPostRequestShippingAddress) Set(val *QuickbooksDesktopInvoicesPostRequestShippingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopInvoicesPostRequestShippingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopInvoicesPostRequestShippingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopInvoicesPostRequestShippingAddress(val *QuickbooksDesktopInvoicesPostRequestShippingAddress) *NullableQuickbooksDesktopInvoicesPostRequestShippingAddress {
	return &NullableQuickbooksDesktopInvoicesPostRequestShippingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopInvoicesPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopInvoicesPostRequestShippingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
