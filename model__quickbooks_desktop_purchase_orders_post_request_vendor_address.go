...
// checks if the QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress{}

// QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress The address of the vendor who sent this purchase order.
type QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress struct {
...
type _QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress
...
func NewQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress() *QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress {
	this := QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress{}
	return &this
}
...
func (o QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress := _QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress(varQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress)
...
type NullableQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress struct {
	value *QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress
	isSet bool
}

func (v NullableQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) Get() *QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) Set(val *QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress(val *QuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) *NullableQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress {
	return &NullableQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopPurchaseOrdersPostRequestVendorAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
