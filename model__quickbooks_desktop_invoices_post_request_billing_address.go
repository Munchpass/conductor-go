...
// checks if the QuickbooksDesktopInvoicesPostRequestBillingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopInvoicesPostRequestBillingAddress{}

// QuickbooksDesktopInvoicesPostRequestBillingAddress The invoice's billing address.
type QuickbooksDesktopInvoicesPostRequestBillingAddress struct {
...
type _QuickbooksDesktopInvoicesPostRequestBillingAddress QuickbooksDesktopInvoicesPostRequestBillingAddress
...
func NewQuickbooksDesktopInvoicesPostRequestBillingAddress() *QuickbooksDesktopInvoicesPostRequestBillingAddress {
	this := QuickbooksDesktopInvoicesPostRequestBillingAddress{}
	return &this
}
...
func (o QuickbooksDesktopInvoicesPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopInvoicesPostRequestBillingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopInvoicesPostRequestBillingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopInvoicesPostRequestBillingAddress := _QuickbooksDesktopInvoicesPostRequestBillingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopInvoicesPostRequestBillingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopInvoicesPostRequestBillingAddress(varQuickbooksDesktopInvoicesPostRequestBillingAddress)
...
type NullableQuickbooksDesktopInvoicesPostRequestBillingAddress struct {
	value *QuickbooksDesktopInvoicesPostRequestBillingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopInvoicesPostRequestBillingAddress) Get() *QuickbooksDesktopInvoicesPostRequestBillingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopInvoicesPostRequestBillingAddress) Set(val *QuickbooksDesktopInvoicesPostRequestBillingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopInvoicesPostRequestBillingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopInvoicesPostRequestBillingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopInvoicesPostRequestBillingAddress(val *QuickbooksDesktopInvoicesPostRequestBillingAddress) *NullableQuickbooksDesktopInvoicesPostRequestBillingAddress {
	return &NullableQuickbooksDesktopInvoicesPostRequestBillingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopInvoicesPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopInvoicesPostRequestBillingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
