...
// checks if the QuickbooksDesktopChecksGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopChecksGet200Response{}

// QuickbooksDesktopChecksGet200Response struct for QuickbooksDesktopChecksGet200Response
type QuickbooksDesktopChecksGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of checks.
	Data []QbdCheck `json:"data"`
...
type _QuickbooksDesktopChecksGet200Response QuickbooksDesktopChecksGet200Response
...
func NewQuickbooksDesktopChecksGet200Response(objectType string, url string, data []QbdCheck, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopChecksGet200Response {
	this := QuickbooksDesktopChecksGet200Response{}
...
func (o QuickbooksDesktopChecksGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopChecksGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopChecksGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopChecksGet200Response := _QuickbooksDesktopChecksGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopChecksGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopChecksGet200Response(varQuickbooksDesktopChecksGet200Response)
...
type NullableQuickbooksDesktopChecksGet200Response struct {
	value *QuickbooksDesktopChecksGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopChecksGet200Response) Get() *QuickbooksDesktopChecksGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopChecksGet200Response) Set(val *QuickbooksDesktopChecksGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopChecksGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopChecksGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopChecksGet200Response(val *QuickbooksDesktopChecksGet200Response) *NullableQuickbooksDesktopChecksGet200Response {
	return &NullableQuickbooksDesktopChecksGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopChecksGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopChecksGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
