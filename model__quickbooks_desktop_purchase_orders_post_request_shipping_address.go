...
// checks if the QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress{}

// QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress The purchase order's shipping address.
type QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress struct {
...
type _QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress
...
func NewQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress() *QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress {
	this := QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress{}
	return &this
}
...
func (o QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress := _QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress(varQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress)
...
type NullableQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress struct {
	value *QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) Get() *QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) Set(val *QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress(val *QuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) *NullableQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress {
	return &NullableQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopPurchaseOrdersPostRequestShippingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
