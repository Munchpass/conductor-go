...
// checks if the QuickbooksDesktopInventorySitesPostRequestAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopInventorySitesPostRequestAddress{}

// QuickbooksDesktopInventorySitesPostRequestAddress The inventory site's address.
type QuickbooksDesktopInventorySitesPostRequestAddress struct {
	// The first line of the site address (e.g., street, PO Box, or company name).  Maximum length: 41 characters.
	Line1 *string `json:"line1,omitempty"`
	// The second line of the site address, if needed (e.g., apartment, suite, unit, or building).  Maximum length: 41 characters.
	Line2 *string `json:"line2,omitempty"`
	// The third line of the site address, if needed.  Maximum length: 41 characters.
	Line3 *string `json:"line3,omitempty"`
	// The fourth line of the site address, if needed.  Maximum length: 41 characters.
	Line4 *string `json:"line4,omitempty"`
	// The fifth line of the site address, if needed.  Maximum length: 41 characters.
	Line5 *string `json:"line5,omitempty"`
	// The city, district, suburb, town, or village name of the site address.  Maximum length: 31 characters.
	City *string `json:"city,omitempty"`
	// The state, county, province, or region name of the site address.  Maximum length: 21 characters.
	State *string `json:"state,omitempty"`
	// The postal code or ZIP code of the site address.  Maximum length: 13 characters.
...
type _QuickbooksDesktopInventorySitesPostRequestAddress QuickbooksDesktopInventorySitesPostRequestAddress
...
func NewQuickbooksDesktopInventorySitesPostRequestAddress() *QuickbooksDesktopInventorySitesPostRequestAddress {
	this := QuickbooksDesktopInventorySitesPostRequestAddress{}
	return &this
}
...
func (o *QuickbooksDesktopInventorySitesPostRequestAddress) GetLine1() string {
...
func (o QuickbooksDesktopInventorySitesPostRequestAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopInventorySitesPostRequestAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopInventorySitesPostRequestAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopInventorySitesPostRequestAddress := _QuickbooksDesktopInventorySitesPostRequestAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopInventorySitesPostRequestAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopInventorySitesPostRequestAddress(varQuickbooksDesktopInventorySitesPostRequestAddress)
...
type NullableQuickbooksDesktopInventorySitesPostRequestAddress struct {
	value *QuickbooksDesktopInventorySitesPostRequestAddress
	isSet bool
}

func (v NullableQuickbooksDesktopInventorySitesPostRequestAddress) Get() *QuickbooksDesktopInventorySitesPostRequestAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopInventorySitesPostRequestAddress) Set(val *QuickbooksDesktopInventorySitesPostRequestAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopInventorySitesPostRequestAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopInventorySitesPostRequestAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopInventorySitesPostRequestAddress(val *QuickbooksDesktopInventorySitesPostRequestAddress) *NullableQuickbooksDesktopInventorySitesPostRequestAddress {
	return &NullableQuickbooksDesktopInventorySitesPostRequestAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopInventorySitesPostRequestAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopInventorySitesPostRequestAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
