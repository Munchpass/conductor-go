...
// checks if the QuickbooksDesktopVendorsIdPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopVendorsIdPostRequest{}

// QuickbooksDesktopVendorsIdPostRequest struct for QuickbooksDesktopVendorsIdPostRequest
type QuickbooksDesktopVendorsIdPostRequest struct {
...
type _QuickbooksDesktopVendorsIdPostRequest QuickbooksDesktopVendorsIdPostRequest
...
func NewQuickbooksDesktopVendorsIdPostRequest(revisionNumber string) *QuickbooksDesktopVendorsIdPostRequest {
	this := QuickbooksDesktopVendorsIdPostRequest{}
...
func (o QuickbooksDesktopVendorsIdPostRequest) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopVendorsIdPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopVendorsIdPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopVendorsIdPostRequest := _QuickbooksDesktopVendorsIdPostRequest{}

	err = json.Unmarshal(data, &varQuickbooksDesktopVendorsIdPostRequest)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopVendorsIdPostRequest(varQuickbooksDesktopVendorsIdPostRequest)
...
type NullableQuickbooksDesktopVendorsIdPostRequest struct {
	value *QuickbooksDesktopVendorsIdPostRequest
	isSet bool
}

func (v NullableQuickbooksDesktopVendorsIdPostRequest) Get() *QuickbooksDesktopVendorsIdPostRequest {
	return v.value
}

func (v *NullableQuickbooksDesktopVendorsIdPostRequest) Set(val *QuickbooksDesktopVendorsIdPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopVendorsIdPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopVendorsIdPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopVendorsIdPostRequest(val *QuickbooksDesktopVendorsIdPostRequest) *NullableQuickbooksDesktopVendorsIdPostRequest {
	return &NullableQuickbooksDesktopVendorsIdPostRequest{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopVendorsIdPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopVendorsIdPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
