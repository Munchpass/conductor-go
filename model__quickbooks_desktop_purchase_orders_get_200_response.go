...
// checks if the QuickbooksDesktopPurchaseOrdersGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopPurchaseOrdersGet200Response{}

// QuickbooksDesktopPurchaseOrdersGet200Response struct for QuickbooksDesktopPurchaseOrdersGet200Response
type QuickbooksDesktopPurchaseOrdersGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of purchase orders.
	Data []QbdPurchaseOrder `json:"data"`
...
type _QuickbooksDesktopPurchaseOrdersGet200Response QuickbooksDesktopPurchaseOrdersGet200Response
...
func NewQuickbooksDesktopPurchaseOrdersGet200Response(objectType string, url string, data []QbdPurchaseOrder, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopPurchaseOrdersGet200Response {
	this := QuickbooksDesktopPurchaseOrdersGet200Response{}
...
func (o QuickbooksDesktopPurchaseOrdersGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopPurchaseOrdersGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopPurchaseOrdersGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopPurchaseOrdersGet200Response := _QuickbooksDesktopPurchaseOrdersGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopPurchaseOrdersGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopPurchaseOrdersGet200Response(varQuickbooksDesktopPurchaseOrdersGet200Response)
...
type NullableQuickbooksDesktopPurchaseOrdersGet200Response struct {
	value *QuickbooksDesktopPurchaseOrdersGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopPurchaseOrdersGet200Response) Get() *QuickbooksDesktopPurchaseOrdersGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopPurchaseOrdersGet200Response) Set(val *QuickbooksDesktopPurchaseOrdersGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopPurchaseOrdersGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopPurchaseOrdersGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopPurchaseOrdersGet200Response(val *QuickbooksDesktopPurchaseOrdersGet200Response) *NullableQuickbooksDesktopPurchaseOrdersGet200Response {
	return &NullableQuickbooksDesktopPurchaseOrdersGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopPurchaseOrdersGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopPurchaseOrdersGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
