...
type _QbdCreditMemoClass QbdCreditMemoClass
...
func (o QbdCreditMemoClass) MarshalJSON() ([]byte, error) {
...
func (o QbdCreditMemoClass) ToMap() (map[string]interface{}, error) {
...
func (o *QbdCreditMemoClass) UnmarshalJSON(data []byte) (err error) {
	...
	varQbdCreditMemoClass := _QbdCreditMemoClass{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQbdCreditMemoClass)

	if err != nil {
		return err
	}

	*o = QbdCreditMemoClass(varQbdCreditMemoClass)

	return err
}

type NullableQbdCreditMemoClass struct {
	value *QbdCreditMemoClass
	isSet bool
}

func (v NullableQbdCreditMemoClass) Get() *QbdCreditMemoClass {
	return v.value
}

func (v *NullableQbdCreditMemoClass) Set(val *QbdCreditMemoClass) {
	v.value = val
	v.isSet = true
}

func (v NullableQbdCreditMemoClass) IsSet() bool {
	return v.isSet
}

func (v *NullableQbdCreditMemoClass) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQbdCreditMemoClass(val *QbdCreditMemoClass) *NullableQbdCreditMemoClass {
	return &NullableQbdCreditMemoClass{value: val, isSet: true}
}

func (v NullableQbdCreditMemoClass) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQbdCreditMemoClass) UnmarshalJSON(src []byte) error {
	v.isSet = true
