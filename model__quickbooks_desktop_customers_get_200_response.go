...
// checks if the QuickbooksDesktopCustomersGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopCustomersGet200Response{}

// QuickbooksDesktopCustomersGet200Response struct for QuickbooksDesktopCustomersGet200Response
type QuickbooksDesktopCustomersGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of customers.
	Data []QbdCustomer `json:"data"`
...
type _QuickbooksDesktopCustomersGet200Response QuickbooksDesktopCustomersGet200Response
...
func NewQuickbooksDesktopCustomersGet200Response(objectType string, url string, data []QbdCustomer, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopCustomersGet200Response {
	this := QuickbooksDesktopCustomersGet200Response{}
...
func (o QuickbooksDesktopCustomersGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopCustomersGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopCustomersGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopCustomersGet200Response := _QuickbooksDesktopCustomersGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopCustomersGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopCustomersGet200Response(varQuickbooksDesktopCustomersGet200Response)
...
type NullableQuickbooksDesktopCustomersGet200Response struct {
	value *QuickbooksDesktopCustomersGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopCustomersGet200Response) Get() *QuickbooksDesktopCustomersGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopCustomersGet200Response) Set(val *QuickbooksDesktopCustomersGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopCustomersGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopCustomersGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopCustomersGet200Response(val *QuickbooksDesktopCustomersGet200Response) *NullableQuickbooksDesktopCustomersGet200Response {
	return &NullableQuickbooksDesktopCustomersGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopCustomersGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopCustomersGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
