...
// checks if the QuickbooksDesktopSalesReceiptsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopSalesReceiptsGet200Response{}

// QuickbooksDesktopSalesReceiptsGet200Response struct for QuickbooksDesktopSalesReceiptsGet200Response
type QuickbooksDesktopSalesReceiptsGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of sales receipts.
	Data []QbdSalesReceipt `json:"data"`
...
type _QuickbooksDesktopSalesReceiptsGet200Response QuickbooksDesktopSalesReceiptsGet200Response
...
func NewQuickbooksDesktopSalesReceiptsGet200Response(objectType string, url string, data []QbdSalesReceipt, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopSalesReceiptsGet200Response {
	this := QuickbooksDesktopSalesReceiptsGet200Response{}
...
func (o QuickbooksDesktopSalesReceiptsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopSalesReceiptsGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopSalesReceiptsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopSalesReceiptsGet200Response := _QuickbooksDesktopSalesReceiptsGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopSalesReceiptsGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopSalesReceiptsGet200Response(varQuickbooksDesktopSalesReceiptsGet200Response)
...
type NullableQuickbooksDesktopSalesReceiptsGet200Response struct {
	value *QuickbooksDesktopSalesReceiptsGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopSalesReceiptsGet200Response) Get() *QuickbooksDesktopSalesReceiptsGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopSalesReceiptsGet200Response) Set(val *QuickbooksDesktopSalesReceiptsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopSalesReceiptsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopSalesReceiptsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopSalesReceiptsGet200Response(val *QuickbooksDesktopSalesReceiptsGet200Response) *NullableQuickbooksDesktopSalesReceiptsGet200Response {
	return &NullableQuickbooksDesktopSalesReceiptsGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopSalesReceiptsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopSalesReceiptsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
