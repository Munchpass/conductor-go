...
// checks if the QuickbooksDesktopChecksPostRequestAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopChecksPostRequestAddress{}

// QuickbooksDesktopChecksPostRequestAddress The address that is printed on the check.
type QuickbooksDesktopChecksPostRequestAddress struct {
...
type _QuickbooksDesktopChecksPostRequestAddress QuickbooksDesktopChecksPostRequestAddress
...
func NewQuickbooksDesktopChecksPostRequestAddress() *QuickbooksDesktopChecksPostRequestAddress {
	this := QuickbooksDesktopChecksPostRequestAddress{}
	return &this
}
...
func (o QuickbooksDesktopChecksPostRequestAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopChecksPostRequestAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopChecksPostRequestAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopChecksPostRequestAddress := _QuickbooksDesktopChecksPostRequestAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopChecksPostRequestAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopChecksPostRequestAddress(varQuickbooksDesktopChecksPostRequestAddress)
...
type NullableQuickbooksDesktopChecksPostRequestAddress struct {
	value *QuickbooksDesktopChecksPostRequestAddress
	isSet bool
}

func (v NullableQuickbooksDesktopChecksPostRequestAddress) Get() *QuickbooksDesktopChecksPostRequestAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopChecksPostRequestAddress) Set(val *QuickbooksDesktopChecksPostRequestAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopChecksPostRequestAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopChecksPostRequestAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopChecksPostRequestAddress(val *QuickbooksDesktopChecksPostRequestAddress) *NullableQuickbooksDesktopChecksPostRequestAddress {
	return &NullableQuickbooksDesktopChecksPostRequestAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopChecksPostRequestAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopChecksPostRequestAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
