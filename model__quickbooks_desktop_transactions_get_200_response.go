...
// checks if the QuickbooksDesktopTransactionsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopTransactionsGet200Response{}

// QuickbooksDesktopTransactionsGet200Response struct for QuickbooksDesktopTransactionsGet200Response
type QuickbooksDesktopTransactionsGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of transactions.
	Data []QbdTransaction `json:"data"`
...
type _QuickbooksDesktopTransactionsGet200Response QuickbooksDesktopTransactionsGet200Response
...
func NewQuickbooksDesktopTransactionsGet200Response(objectType string, url string, data []QbdTransaction, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopTransactionsGet200Response {
	this := QuickbooksDesktopTransactionsGet200Response{}
...
func (o QuickbooksDesktopTransactionsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopTransactionsGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopTransactionsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopTransactionsGet200Response := _QuickbooksDesktopTransactionsGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopTransactionsGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopTransactionsGet200Response(varQuickbooksDesktopTransactionsGet200Response)
...
type NullableQuickbooksDesktopTransactionsGet200Response struct {
	value *QuickbooksDesktopTransactionsGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopTransactionsGet200Response) Get() *QuickbooksDesktopTransactionsGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopTransactionsGet200Response) Set(val *QuickbooksDesktopTransactionsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopTransactionsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopTransactionsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopTransactionsGet200Response(val *QuickbooksDesktopTransactionsGet200Response) *NullableQuickbooksDesktopTransactionsGet200Response {
	return &NullableQuickbooksDesktopTransactionsGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopTransactionsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopTransactionsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
