...
// checks if the QuickbooksDesktopReceivePaymentsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopReceivePaymentsGet200Response{}

// QuickbooksDesktopReceivePaymentsGet200Response struct for QuickbooksDesktopReceivePaymentsGet200Response
type QuickbooksDesktopReceivePaymentsGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of receive-payments.
	Data []QbdReceivePayment `json:"data"`
...
type _QuickbooksDesktopReceivePaymentsGet200Response QuickbooksDesktopReceivePaymentsGet200Response
...
func NewQuickbooksDesktopReceivePaymentsGet200Response(objectType string, url string, data []QbdReceivePayment, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopReceivePaymentsGet200Response {
	this := QuickbooksDesktopReceivePaymentsGet200Response{}
...
func (o QuickbooksDesktopReceivePaymentsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopReceivePaymentsGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopReceivePaymentsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopReceivePaymentsGet200Response := _QuickbooksDesktopReceivePaymentsGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopReceivePaymentsGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopReceivePaymentsGet200Response(varQuickbooksDesktopReceivePaymentsGet200Response)
...
type NullableQuickbooksDesktopReceivePaymentsGet200Response struct {
	value *QuickbooksDesktopReceivePaymentsGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopReceivePaymentsGet200Response) Get() *QuickbooksDesktopReceivePaymentsGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopReceivePaymentsGet200Response) Set(val *QuickbooksDesktopReceivePaymentsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopReceivePaymentsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopReceivePaymentsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopReceivePaymentsGet200Response(val *QuickbooksDesktopReceivePaymentsGet200Response) *NullableQuickbooksDesktopReceivePaymentsGet200Response {
	return &NullableQuickbooksDesktopReceivePaymentsGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopReceivePaymentsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopReceivePaymentsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
