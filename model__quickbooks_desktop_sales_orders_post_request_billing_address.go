...
// checks if the QuickbooksDesktopSalesOrdersPostRequestBillingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopSalesOrdersPostRequestBillingAddress{}

// QuickbooksDesktopSalesOrdersPostRequestBillingAddress The sales order's billing address.
type QuickbooksDesktopSalesOrdersPostRequestBillingAddress struct {
...
type _QuickbooksDesktopSalesOrdersPostRequestBillingAddress QuickbooksDesktopSalesOrdersPostRequestBillingAddress
...
func NewQuickbooksDesktopSalesOrdersPostRequestBillingAddress() *QuickbooksDesktopSalesOrdersPostRequestBillingAddress {
	this := QuickbooksDesktopSalesOrdersPostRequestBillingAddress{}
	return &this
}
...
func (o QuickbooksDesktopSalesOrdersPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopSalesOrdersPostRequestBillingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopSalesOrdersPostRequestBillingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopSalesOrdersPostRequestBillingAddress := _QuickbooksDesktopSalesOrdersPostRequestBillingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopSalesOrdersPostRequestBillingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopSalesOrdersPostRequestBillingAddress(varQuickbooksDesktopSalesOrdersPostRequestBillingAddress)
...
type NullableQuickbooksDesktopSalesOrdersPostRequestBillingAddress struct {
	value *QuickbooksDesktopSalesOrdersPostRequestBillingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopSalesOrdersPostRequestBillingAddress) Get() *QuickbooksDesktopSalesOrdersPostRequestBillingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopSalesOrdersPostRequestBillingAddress) Set(val *QuickbooksDesktopSalesOrdersPostRequestBillingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopSalesOrdersPostRequestBillingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopSalesOrdersPostRequestBillingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopSalesOrdersPostRequestBillingAddress(val *QuickbooksDesktopSalesOrdersPostRequestBillingAddress) *NullableQuickbooksDesktopSalesOrdersPostRequestBillingAddress {
	return &NullableQuickbooksDesktopSalesOrdersPostRequestBillingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopSalesOrdersPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopSalesOrdersPostRequestBillingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
