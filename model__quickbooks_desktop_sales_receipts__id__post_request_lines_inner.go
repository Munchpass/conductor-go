...
// checks if the QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner{}

// QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner struct for QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner
type QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner struct {
	// The QuickBooks-assigned unique identifier of an existing sales receipt line you wish to retain or update.  **IMPORTANT**: Set this field to `-1` for new sales receipt lines you wish to add.
	Id string `json:"id"`
...
type _QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner
...
func NewQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner(id string) *QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner {
	this := QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner{}
	this.Id = id
	return &this
}
...
func (o QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner := _QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner{}

	err = json.Unmarshal(data, &varQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner(varQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner)
...
type NullableQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner struct {
	value *QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner
	isSet bool
}

func (v NullableQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) Get() *QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner {
	return v.value
}

func (v *NullableQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) Set(val *QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner(val *QuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) *NullableQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner {
	return &NullableQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopSalesReceiptsIdPostRequestLinesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
