...
// checks if the QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner{}

// QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner struct for QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner
type QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner struct {
	// The QuickBooks-assigned unique identifier of an existing invoice line group you wish to retain or update.  **IMPORTANT**: Set this field to `-1` for new invoice line groups you wish to add.
	Id string `json:"id"`
	...
	// The invoice line group's line items, each representing a single product or service sold.  **IMPORTANT**:  1. Including this array in your update request will **REPLACE** all existing line items for the invoice line group with this array. To keep any existing line items, you must include them in this array even if they have not changed. **Any line items not included will be removed.**  2. To add a new line item, include it here with the `id` field set to `-1`.  3. If you do not wish to modify any line items, omit this field entirely to keep them unchanged.
	Lines []QuickbooksDesktopInvoicesIdPostRequestLinesInner `json:"lines,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner
...
func NewQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner(id string) *QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner {
	this := QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner{}
	this.Id = id
	return &this
}
...
func (o QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner := _QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner{}

	err = json.Unmarshal(data, &varQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner(varQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner)
...
type NullableQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner struct {
	value *QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner
	isSet bool
}

func (v NullableQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) Get() *QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner {
	return v.value
}

func (v *NullableQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) Set(val *QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner(val *QuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) *NullableQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner {
	return &NullableQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopInvoicesIdPostRequestLineGroupsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
