...
// checks if the QuickbooksDesktopCreditCardChargesGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopCreditCardChargesGet200Response{}

// QuickbooksDesktopCreditCardChargesGet200Response struct for QuickbooksDesktopCreditCardChargesGet200Response
type QuickbooksDesktopCreditCardChargesGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of credit card charges.
	Data []QbdCreditCardCharge `json:"data"`
...
type _QuickbooksDesktopCreditCardChargesGet200Response QuickbooksDesktopCreditCardChargesGet200Response
...
func NewQuickbooksDesktopCreditCardChargesGet200Response(objectType string, url string, data []QbdCreditCardCharge, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopCreditCardChargesGet200Response {
	this := QuickbooksDesktopCreditCardChargesGet200Response{}
...
func (o QuickbooksDesktopCreditCardChargesGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopCreditCardChargesGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopCreditCardChargesGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopCreditCardChargesGet200Response := _QuickbooksDesktopCreditCardChargesGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopCreditCardChargesGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopCreditCardChargesGet200Response(varQuickbooksDesktopCreditCardChargesGet200Response)
...
type NullableQuickbooksDesktopCreditCardChargesGet200Response struct {
	value *QuickbooksDesktopCreditCardChargesGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopCreditCardChargesGet200Response) Get() *QuickbooksDesktopCreditCardChargesGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopCreditCardChargesGet200Response) Set(val *QuickbooksDesktopCreditCardChargesGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopCreditCardChargesGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopCreditCardChargesGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopCreditCardChargesGet200Response(val *QuickbooksDesktopCreditCardChargesGet200Response) *NullableQuickbooksDesktopCreditCardChargesGet200Response {
	return &NullableQuickbooksDesktopCreditCardChargesGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopCreditCardChargesGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopCreditCardChargesGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
