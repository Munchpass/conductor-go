...
// checks if the QuickbooksDesktopSalesReceiptsPostRequestLinesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopSalesReceiptsPostRequestLinesInner{}

// QuickbooksDesktopSalesReceiptsPostRequestLinesInner struct for QuickbooksDesktopSalesReceiptsPostRequestLinesInner
type QuickbooksDesktopSalesReceiptsPostRequestLinesInner struct {
	...
	// The sales-tax code for this sales receipt line, determining whether it is taxable or non-taxable. If set, this overrides any sales-tax codes defined on the parent transaction or the associated item.  Default codes include \"Non\" (non-taxable) and \"Tax\" (taxable), but custom codes can also be created in QuickBooks. If QuickBooks is not set up to charge sales tax (via the \"Do You Charge Sales Tax?\" preference), it will assign the default non-taxable code to all sales.
	...
	CreditCardTransaction *QuickbooksDesktopSalesReceiptsPostRequestLinesInnerCreditCardTransaction `json:"creditCardTransaction,omitempty"`
...
type _QuickbooksDesktopSalesReceiptsPostRequestLinesInner QuickbooksDesktopSalesReceiptsPostRequestLinesInner
...
func NewQuickbooksDesktopSalesReceiptsPostRequestLinesInner() *QuickbooksDesktopSalesReceiptsPostRequestLinesInner {
	this := QuickbooksDesktopSalesReceiptsPostRequestLinesInner{}
	return &this
}
...
func (o *QuickbooksDesktopSalesReceiptsPostRequestLinesInner) GetCreditCardTransaction() QuickbooksDesktopSalesReceiptsPostRequestLinesInnerCreditCardTransaction {
	if o == nil || IsNil(o.CreditCardTransaction) {
		var ret QuickbooksDesktopSalesReceiptsPostRequestLinesInnerCreditCardTransaction
		return ret
	}
...
// SetCreditCardTransaction gets a reference to the given QuickbooksDesktopSalesReceiptsPostRequestLinesInnerCreditCardTransaction and assigns it to the CreditCardTransaction field.
...
func (o QuickbooksDesktopSalesReceiptsPostRequestLinesInner) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopSalesReceiptsPostRequestLinesInner) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopSalesReceiptsPostRequestLinesInner) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopSalesReceiptsPostRequestLinesInner := _QuickbooksDesktopSalesReceiptsPostRequestLinesInner{}

	err = json.Unmarshal(data, &varQuickbooksDesktopSalesReceiptsPostRequestLinesInner)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopSalesReceiptsPostRequestLinesInner(varQuickbooksDesktopSalesReceiptsPostRequestLinesInner)
...
type NullableQuickbooksDesktopSalesReceiptsPostRequestLinesInner struct {
	value *QuickbooksDesktopSalesReceiptsPostRequestLinesInner
	isSet bool
}

func (v NullableQuickbooksDesktopSalesReceiptsPostRequestLinesInner) Get() *QuickbooksDesktopSalesReceiptsPostRequestLinesInner {
	return v.value
}

func (v *NullableQuickbooksDesktopSalesReceiptsPostRequestLinesInner) Set(val *QuickbooksDesktopSalesReceiptsPostRequestLinesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopSalesReceiptsPostRequestLinesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopSalesReceiptsPostRequestLinesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopSalesReceiptsPostRequestLinesInner(val *QuickbooksDesktopSalesReceiptsPostRequestLinesInner) *NullableQuickbooksDesktopSalesReceiptsPostRequestLinesInner {
	return &NullableQuickbooksDesktopSalesReceiptsPostRequestLinesInner{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopSalesReceiptsPostRequestLinesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopSalesReceiptsPostRequestLinesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
