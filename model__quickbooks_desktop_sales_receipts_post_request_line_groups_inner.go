...
// checks if the QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner{}

// QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner struct for QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner
type QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner struct {
...
type _QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner
...
func NewQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner(itemGroupId string) *QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner {
	this := QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner{}
...
func (o QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner := _QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner{}

	err = json.Unmarshal(data, &varQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner(varQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner)
...
type NullableQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner struct {
	value *QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner
	isSet bool
}

func (v NullableQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) Get() *QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner {
	return v.value
}

func (v *NullableQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) Set(val *QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner(val *QuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) *NullableQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner {
	return &NullableQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopSalesReceiptsPostRequestLineGroupsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
