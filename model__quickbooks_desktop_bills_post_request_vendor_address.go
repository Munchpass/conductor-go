...
// checks if the QuickbooksDesktopBillsPostRequestVendorAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopBillsPostRequestVendorAddress{}

// QuickbooksDesktopBillsPostRequestVendorAddress The address of the vendor who sent this bill.
type QuickbooksDesktopBillsPostRequestVendorAddress struct {
...
type _QuickbooksDesktopBillsPostRequestVendorAddress QuickbooksDesktopBillsPostRequestVendorAddress
...
func NewQuickbooksDesktopBillsPostRequestVendorAddress() *QuickbooksDesktopBillsPostRequestVendorAddress {
	this := QuickbooksDesktopBillsPostRequestVendorAddress{}
	return &this
}
...
func (o QuickbooksDesktopBillsPostRequestVendorAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopBillsPostRequestVendorAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopBillsPostRequestVendorAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopBillsPostRequestVendorAddress := _QuickbooksDesktopBillsPostRequestVendorAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopBillsPostRequestVendorAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopBillsPostRequestVendorAddress(varQuickbooksDesktopBillsPostRequestVendorAddress)
...
type NullableQuickbooksDesktopBillsPostRequestVendorAddress struct {
	value *QuickbooksDesktopBillsPostRequestVendorAddress
	isSet bool
}

func (v NullableQuickbooksDesktopBillsPostRequestVendorAddress) Get() *QuickbooksDesktopBillsPostRequestVendorAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopBillsPostRequestVendorAddress) Set(val *QuickbooksDesktopBillsPostRequestVendorAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopBillsPostRequestVendorAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopBillsPostRequestVendorAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopBillsPostRequestVendorAddress(val *QuickbooksDesktopBillsPostRequestVendorAddress) *NullableQuickbooksDesktopBillsPostRequestVendorAddress {
	return &NullableQuickbooksDesktopBillsPostRequestVendorAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopBillsPostRequestVendorAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopBillsPostRequestVendorAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
