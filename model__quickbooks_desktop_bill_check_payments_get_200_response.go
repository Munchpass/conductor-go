...
// checks if the QuickbooksDesktopBillCheckPaymentsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopBillCheckPaymentsGet200Response{}

// QuickbooksDesktopBillCheckPaymentsGet200Response struct for QuickbooksDesktopBillCheckPaymentsGet200Response
type QuickbooksDesktopBillCheckPaymentsGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of bill check payments.
	Data []QbdBillCheckPayment `json:"data"`
...
type _QuickbooksDesktopBillCheckPaymentsGet200Response QuickbooksDesktopBillCheckPaymentsGet200Response
...
func NewQuickbooksDesktopBillCheckPaymentsGet200Response(objectType string, url string, data []QbdBillCheckPayment, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopBillCheckPaymentsGet200Response {
	this := QuickbooksDesktopBillCheckPaymentsGet200Response{}
...
func (o QuickbooksDesktopBillCheckPaymentsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopBillCheckPaymentsGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopBillCheckPaymentsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopBillCheckPaymentsGet200Response := _QuickbooksDesktopBillCheckPaymentsGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopBillCheckPaymentsGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopBillCheckPaymentsGet200Response(varQuickbooksDesktopBillCheckPaymentsGet200Response)
...
type NullableQuickbooksDesktopBillCheckPaymentsGet200Response struct {
	value *QuickbooksDesktopBillCheckPaymentsGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopBillCheckPaymentsGet200Response) Get() *QuickbooksDesktopBillCheckPaymentsGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopBillCheckPaymentsGet200Response) Set(val *QuickbooksDesktopBillCheckPaymentsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopBillCheckPaymentsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopBillCheckPaymentsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopBillCheckPaymentsGet200Response(val *QuickbooksDesktopBillCheckPaymentsGet200Response) *NullableQuickbooksDesktopBillCheckPaymentsGet200Response {
	return &NullableQuickbooksDesktopBillCheckPaymentsGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopBillCheckPaymentsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopBillCheckPaymentsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
