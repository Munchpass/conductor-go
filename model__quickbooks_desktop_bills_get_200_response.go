...
// checks if the QuickbooksDesktopBillsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopBillsGet200Response{}

// QuickbooksDesktopBillsGet200Response struct for QuickbooksDesktopBillsGet200Response
type QuickbooksDesktopBillsGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of bills.
	Data []QbdBill `json:"data"`
...
type _QuickbooksDesktopBillsGet200Response QuickbooksDesktopBillsGet200Response
...
func NewQuickbooksDesktopBillsGet200Response(objectType string, url string, data []QbdBill, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopBillsGet200Response {
	this := QuickbooksDesktopBillsGet200Response{}
...
func (o QuickbooksDesktopBillsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopBillsGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopBillsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopBillsGet200Response := _QuickbooksDesktopBillsGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopBillsGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopBillsGet200Response(varQuickbooksDesktopBillsGet200Response)
...
type NullableQuickbooksDesktopBillsGet200Response struct {
	value *QuickbooksDesktopBillsGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopBillsGet200Response) Get() *QuickbooksDesktopBillsGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopBillsGet200Response) Set(val *QuickbooksDesktopBillsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopBillsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopBillsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopBillsGet200Response(val *QuickbooksDesktopBillsGet200Response) *NullableQuickbooksDesktopBillsGet200Response {
	return &NullableQuickbooksDesktopBillsGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopBillsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopBillsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
