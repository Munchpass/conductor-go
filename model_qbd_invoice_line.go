...
// checks if the QbdInvoiceLine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QbdInvoiceLine{}

// QbdInvoiceLine struct for QbdInvoiceLine
type QbdInvoiceLine struct {
	// The unique identifier assigned by QuickBooks to this invoice line. This ID is unique across all transaction line types.
	Id string `json:"id"`
	// The type of object. This value is always `\"qbd_invoice_line\"`.
	ObjectType string `json:"objectType"`
	Item QbdInvoiceLineItem `json:"item"`
	...
	OverrideUnitOfMeasureSet QbdInvoiceLineOverrideUnitOfMeasureSet `json:"overrideUnitOfMeasureSet"`
	...
	Class QbdInvoiceLineClass `json:"class"`
	...
	InventorySite QbdInvoiceLineInventorySite `json:"inventorySite"`
	InventorySiteLocation QbdInvoiceLineInventorySiteLocation `json:"inventorySiteLocation"`
	...
	// The expiration date for the serial number or lot number of the item associated with this invoice line, in ISO 8601 format (YYYY-MM-DD). This is particularly relevant for perishable or time-sensitive inventory items. Note that this field is only supported on QuickBooks Desktop 2023 or later.
	...
	SalesTaxCode QbdInvoiceLineSalesTaxCode `json:"salesTaxCode"`
...
type _QbdInvoiceLine QbdInvoiceLine
...
func (o *QbdInvoiceLine) GetOverrideUnitOfMeasureSet() QbdInvoiceLineOverrideUnitOfMeasureSet {
	if o == nil {
		var ret QbdInvoiceLineOverrideUnitOfMeasureSet
		return ret
	}
...
func (o *QbdInvoiceLine) GetInventorySite() QbdInvoiceLineInventorySite {
	if o == nil {
		var ret QbdInvoiceLineInventorySite
		return ret
	}
...
func (o *QbdInvoiceLine) GetInventorySiteLocation() QbdInvoiceLineInventorySiteLocation {
	if o == nil {
		var ret QbdInvoiceLineInventorySiteLocation
		return ret
	}
...
func (o *QbdInvoiceLine) GetSalesTaxCode() QbdInvoiceLineSalesTaxCode {
	if o == nil {
		var ret QbdInvoiceLineSalesTaxCode
		return ret
	}
...
func (o QbdInvoiceLine) MarshalJSON() ([]byte, error) {
...
func (o QbdInvoiceLine) ToMap() (map[string]interface{}, error) {
...
func (o *QbdInvoiceLine) UnmarshalJSON(data []byte) (err error) {
	...
	varQbdInvoiceLine := _QbdInvoiceLine{}

	err = json.Unmarshal(data, &varQbdInvoiceLine)

	if err != nil {
		return err
	}

	*o = QbdInvoiceLine(varQbdInvoiceLine)
...
type NullableQbdInvoiceLine struct {
	value *QbdInvoiceLine
	isSet bool
}

func (v NullableQbdInvoiceLine) Get() *QbdInvoiceLine {
	return v.value
}

func (v *NullableQbdInvoiceLine) Set(val *QbdInvoiceLine) {
	v.value = val
	v.isSet = true
}

func (v NullableQbdInvoiceLine) IsSet() bool {
	return v.isSet
}

func (v *NullableQbdInvoiceLine) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQbdInvoiceLine(val *QbdInvoiceLine) *NullableQbdInvoiceLine {
	return &NullableQbdInvoiceLine{value: val, isSet: true}
}

func (v NullableQbdInvoiceLine) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQbdInvoiceLine) UnmarshalJSON(src []byte) error {
	v.isSet = true
