...
// checks if the QuickbooksDesktopSalesReceiptsPostRequestBillingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopSalesReceiptsPostRequestBillingAddress{}

// QuickbooksDesktopSalesReceiptsPostRequestBillingAddress The sales receipt's billing address.
type QuickbooksDesktopSalesReceiptsPostRequestBillingAddress struct {
...
type _QuickbooksDesktopSalesReceiptsPostRequestBillingAddress QuickbooksDesktopSalesReceiptsPostRequestBillingAddress
...
func NewQuickbooksDesktopSalesReceiptsPostRequestBillingAddress() *QuickbooksDesktopSalesReceiptsPostRequestBillingAddress {
	this := QuickbooksDesktopSalesReceiptsPostRequestBillingAddress{}
	return &this
}
...
func (o QuickbooksDesktopSalesReceiptsPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopSalesReceiptsPostRequestBillingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopSalesReceiptsPostRequestBillingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopSalesReceiptsPostRequestBillingAddress := _QuickbooksDesktopSalesReceiptsPostRequestBillingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopSalesReceiptsPostRequestBillingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopSalesReceiptsPostRequestBillingAddress(varQuickbooksDesktopSalesReceiptsPostRequestBillingAddress)
...
type NullableQuickbooksDesktopSalesReceiptsPostRequestBillingAddress struct {
	value *QuickbooksDesktopSalesReceiptsPostRequestBillingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopSalesReceiptsPostRequestBillingAddress) Get() *QuickbooksDesktopSalesReceiptsPostRequestBillingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopSalesReceiptsPostRequestBillingAddress) Set(val *QuickbooksDesktopSalesReceiptsPostRequestBillingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopSalesReceiptsPostRequestBillingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopSalesReceiptsPostRequestBillingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopSalesReceiptsPostRequestBillingAddress(val *QuickbooksDesktopSalesReceiptsPostRequestBillingAddress) *NullableQuickbooksDesktopSalesReceiptsPostRequestBillingAddress {
	return &NullableQuickbooksDesktopSalesReceiptsPostRequestBillingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopSalesReceiptsPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopSalesReceiptsPostRequestBillingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
