...
// checks if the QuickbooksDesktopSalesTaxItemsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopSalesTaxItemsGet200Response{}

// QuickbooksDesktopSalesTaxItemsGet200Response struct for QuickbooksDesktopSalesTaxItemsGet200Response
type QuickbooksDesktopSalesTaxItemsGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of sales-tax items.
	Data []QbdSalesTaxItem `json:"data"`
...
type _QuickbooksDesktopSalesTaxItemsGet200Response QuickbooksDesktopSalesTaxItemsGet200Response
...
func NewQuickbooksDesktopSalesTaxItemsGet200Response(objectType string, url string, data []QbdSalesTaxItem, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopSalesTaxItemsGet200Response {
	this := QuickbooksDesktopSalesTaxItemsGet200Response{}
...
func (o QuickbooksDesktopSalesTaxItemsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopSalesTaxItemsGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopSalesTaxItemsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopSalesTaxItemsGet200Response := _QuickbooksDesktopSalesTaxItemsGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopSalesTaxItemsGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopSalesTaxItemsGet200Response(varQuickbooksDesktopSalesTaxItemsGet200Response)
...
type NullableQuickbooksDesktopSalesTaxItemsGet200Response struct {
	value *QuickbooksDesktopSalesTaxItemsGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopSalesTaxItemsGet200Response) Get() *QuickbooksDesktopSalesTaxItemsGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopSalesTaxItemsGet200Response) Set(val *QuickbooksDesktopSalesTaxItemsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopSalesTaxItemsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopSalesTaxItemsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopSalesTaxItemsGet200Response(val *QuickbooksDesktopSalesTaxItemsGet200Response) *NullableQuickbooksDesktopSalesTaxItemsGet200Response {
	return &NullableQuickbooksDesktopSalesTaxItemsGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopSalesTaxItemsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopSalesTaxItemsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
