...
// checks if the QbdAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QbdAddress{}

// QbdAddress struct for QbdAddress
type QbdAddress struct {
...
func (o QbdAddress) MarshalJSON() ([]byte, error) {
...
func (o QbdAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QbdAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varQbdAddress := _QbdAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQbdAddress)

	if err != nil {
		return err
	}

	*o = QbdAddress(varQbdAddress)

	return err
}

type NullableQbdAddress struct {
	value *QbdAddress
	isSet bool
}

func (v NullableQbdAddress) Get() *QbdAddress {
	return v.value
}

func (v *NullableQbdAddress) Set(val *QbdAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQbdAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQbdAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQbdAddress(val *QbdAddress) *NullableQbdAddress {
	return &NullableQbdAddress{value: val, isSet: true}
}

func (v NullableQbdAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQbdAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
