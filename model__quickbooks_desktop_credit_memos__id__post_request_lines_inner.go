...
// checks if the QuickbooksDesktopCreditMemosIdPostRequestLinesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopCreditMemosIdPostRequestLinesInner{}

// QuickbooksDesktopCreditMemosIdPostRequestLinesInner struct for QuickbooksDesktopCreditMemosIdPostRequestLinesInner
type QuickbooksDesktopCreditMemosIdPostRequestLinesInner struct {
	// The QuickBooks-assigned unique identifier of an existing credit memo line you wish to retain or update.  **IMPORTANT**: Set this field to `-1` for new credit memo lines you wish to add.
	Id string `json:"id"`
...
type _QuickbooksDesktopCreditMemosIdPostRequestLinesInner QuickbooksDesktopCreditMemosIdPostRequestLinesInner
...
func NewQuickbooksDesktopCreditMemosIdPostRequestLinesInner(id string) *QuickbooksDesktopCreditMemosIdPostRequestLinesInner {
	this := QuickbooksDesktopCreditMemosIdPostRequestLinesInner{}
	this.Id = id
	return &this
}
...
func (o QuickbooksDesktopCreditMemosIdPostRequestLinesInner) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopCreditMemosIdPostRequestLinesInner) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopCreditMemosIdPostRequestLinesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopCreditMemosIdPostRequestLinesInner := _QuickbooksDesktopCreditMemosIdPostRequestLinesInner{}

	err = json.Unmarshal(data, &varQuickbooksDesktopCreditMemosIdPostRequestLinesInner)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopCreditMemosIdPostRequestLinesInner(varQuickbooksDesktopCreditMemosIdPostRequestLinesInner)
...
type NullableQuickbooksDesktopCreditMemosIdPostRequestLinesInner struct {
	value *QuickbooksDesktopCreditMemosIdPostRequestLinesInner
	isSet bool
}

func (v NullableQuickbooksDesktopCreditMemosIdPostRequestLinesInner) Get() *QuickbooksDesktopCreditMemosIdPostRequestLinesInner {
	return v.value
}

func (v *NullableQuickbooksDesktopCreditMemosIdPostRequestLinesInner) Set(val *QuickbooksDesktopCreditMemosIdPostRequestLinesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopCreditMemosIdPostRequestLinesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopCreditMemosIdPostRequestLinesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopCreditMemosIdPostRequestLinesInner(val *QuickbooksDesktopCreditMemosIdPostRequestLinesInner) *NullableQuickbooksDesktopCreditMemosIdPostRequestLinesInner {
	return &NullableQuickbooksDesktopCreditMemosIdPostRequestLinesInner{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopCreditMemosIdPostRequestLinesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopCreditMemosIdPostRequestLinesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
