...
// checks if the QuickbooksDesktopCustomersPostRequestShippingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopCustomersPostRequestShippingAddress{}

// QuickbooksDesktopCustomersPostRequestShippingAddress The customer's shipping address.
type QuickbooksDesktopCustomersPostRequestShippingAddress struct {
...
type _QuickbooksDesktopCustomersPostRequestShippingAddress QuickbooksDesktopCustomersPostRequestShippingAddress
...
func NewQuickbooksDesktopCustomersPostRequestShippingAddress() *QuickbooksDesktopCustomersPostRequestShippingAddress {
	this := QuickbooksDesktopCustomersPostRequestShippingAddress{}
	return &this
}
...
func (o QuickbooksDesktopCustomersPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopCustomersPostRequestShippingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopCustomersPostRequestShippingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopCustomersPostRequestShippingAddress := _QuickbooksDesktopCustomersPostRequestShippingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopCustomersPostRequestShippingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopCustomersPostRequestShippingAddress(varQuickbooksDesktopCustomersPostRequestShippingAddress)
...
type NullableQuickbooksDesktopCustomersPostRequestShippingAddress struct {
	value *QuickbooksDesktopCustomersPostRequestShippingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopCustomersPostRequestShippingAddress) Get() *QuickbooksDesktopCustomersPostRequestShippingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopCustomersPostRequestShippingAddress) Set(val *QuickbooksDesktopCustomersPostRequestShippingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopCustomersPostRequestShippingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopCustomersPostRequestShippingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopCustomersPostRequestShippingAddress(val *QuickbooksDesktopCustomersPostRequestShippingAddress) *NullableQuickbooksDesktopCustomersPostRequestShippingAddress {
	return &NullableQuickbooksDesktopCustomersPostRequestShippingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopCustomersPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopCustomersPostRequestShippingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
