...
// checks if the QbdSalesReceiptLineClass type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QbdSalesReceiptLineClass{}
...
type QbdSalesReceiptLineClass struct {
...
type _QbdSalesReceiptLineClass QbdSalesReceiptLineClass
...
func (o QbdSalesReceiptLineClass) MarshalJSON() ([]byte, error) {
...
func (o QbdSalesReceiptLineClass) ToMap() (map[string]interface{}, error) {
...
func (o *QbdSalesReceiptLineClass) UnmarshalJSON(data []byte) (err error) {
	...
	varQbdSalesReceiptLineClass := _QbdSalesReceiptLineClass{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQbdSalesReceiptLineClass)

	if err != nil {
		return err
	}

	*o = QbdSalesReceiptLineClass(varQbdSalesReceiptLineClass)

	return err
}

type NullableQbdSalesReceiptLineClass struct {
	value *QbdSalesReceiptLineClass
	isSet bool
}

func (v NullableQbdSalesReceiptLineClass) Get() *QbdSalesReceiptLineClass {
	return v.value
}

func (v *NullableQbdSalesReceiptLineClass) Set(val *QbdSalesReceiptLineClass) {
	v.value = val
	v.isSet = true
}

func (v NullableQbdSalesReceiptLineClass) IsSet() bool {
	return v.isSet
}

func (v *NullableQbdSalesReceiptLineClass) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQbdSalesReceiptLineClass(val *QbdSalesReceiptLineClass) *NullableQbdSalesReceiptLineClass {
	return &NullableQbdSalesReceiptLineClass{value: val, isSet: true}
}

func (v NullableQbdSalesReceiptLineClass) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQbdSalesReceiptLineClass) UnmarshalJSON(src []byte) error {
	v.isSet = true
