...
// checks if the QuickbooksDesktopEstimatesPostRequestShippingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopEstimatesPostRequestShippingAddress{}

// QuickbooksDesktopEstimatesPostRequestShippingAddress The estimate's shipping address.
type QuickbooksDesktopEstimatesPostRequestShippingAddress struct {
...
type _QuickbooksDesktopEstimatesPostRequestShippingAddress QuickbooksDesktopEstimatesPostRequestShippingAddress
...
func NewQuickbooksDesktopEstimatesPostRequestShippingAddress() *QuickbooksDesktopEstimatesPostRequestShippingAddress {
	this := QuickbooksDesktopEstimatesPostRequestShippingAddress{}
	return &this
}
...
func (o QuickbooksDesktopEstimatesPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopEstimatesPostRequestShippingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopEstimatesPostRequestShippingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopEstimatesPostRequestShippingAddress := _QuickbooksDesktopEstimatesPostRequestShippingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopEstimatesPostRequestShippingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopEstimatesPostRequestShippingAddress(varQuickbooksDesktopEstimatesPostRequestShippingAddress)
...
type NullableQuickbooksDesktopEstimatesPostRequestShippingAddress struct {
	value *QuickbooksDesktopEstimatesPostRequestShippingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopEstimatesPostRequestShippingAddress) Get() *QuickbooksDesktopEstimatesPostRequestShippingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopEstimatesPostRequestShippingAddress) Set(val *QuickbooksDesktopEstimatesPostRequestShippingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopEstimatesPostRequestShippingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopEstimatesPostRequestShippingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopEstimatesPostRequestShippingAddress(val *QuickbooksDesktopEstimatesPostRequestShippingAddress) *NullableQuickbooksDesktopEstimatesPostRequestShippingAddress {
	return &NullableQuickbooksDesktopEstimatesPostRequestShippingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopEstimatesPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopEstimatesPostRequestShippingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
