...
// checks if the QuickbooksDesktopEstimatesPostRequestBillingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopEstimatesPostRequestBillingAddress{}

// QuickbooksDesktopEstimatesPostRequestBillingAddress The estimate's billing address.
type QuickbooksDesktopEstimatesPostRequestBillingAddress struct {
...
type _QuickbooksDesktopEstimatesPostRequestBillingAddress QuickbooksDesktopEstimatesPostRequestBillingAddress
...
func NewQuickbooksDesktopEstimatesPostRequestBillingAddress() *QuickbooksDesktopEstimatesPostRequestBillingAddress {
	this := QuickbooksDesktopEstimatesPostRequestBillingAddress{}
	return &this
}
...
func (o QuickbooksDesktopEstimatesPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopEstimatesPostRequestBillingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopEstimatesPostRequestBillingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopEstimatesPostRequestBillingAddress := _QuickbooksDesktopEstimatesPostRequestBillingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopEstimatesPostRequestBillingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopEstimatesPostRequestBillingAddress(varQuickbooksDesktopEstimatesPostRequestBillingAddress)
...
type NullableQuickbooksDesktopEstimatesPostRequestBillingAddress struct {
	value *QuickbooksDesktopEstimatesPostRequestBillingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopEstimatesPostRequestBillingAddress) Get() *QuickbooksDesktopEstimatesPostRequestBillingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopEstimatesPostRequestBillingAddress) Set(val *QuickbooksDesktopEstimatesPostRequestBillingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopEstimatesPostRequestBillingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopEstimatesPostRequestBillingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopEstimatesPostRequestBillingAddress(val *QuickbooksDesktopEstimatesPostRequestBillingAddress) *NullableQuickbooksDesktopEstimatesPostRequestBillingAddress {
	return &NullableQuickbooksDesktopEstimatesPostRequestBillingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopEstimatesPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopEstimatesPostRequestBillingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
