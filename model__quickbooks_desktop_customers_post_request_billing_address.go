...
// checks if the QuickbooksDesktopCustomersPostRequestBillingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopCustomersPostRequestBillingAddress{}

// QuickbooksDesktopCustomersPostRequestBillingAddress The customer's billing address.
type QuickbooksDesktopCustomersPostRequestBillingAddress struct {
...
type _QuickbooksDesktopCustomersPostRequestBillingAddress QuickbooksDesktopCustomersPostRequestBillingAddress
...
func NewQuickbooksDesktopCustomersPostRequestBillingAddress() *QuickbooksDesktopCustomersPostRequestBillingAddress {
	this := QuickbooksDesktopCustomersPostRequestBillingAddress{}
	return &this
}
...
func (o QuickbooksDesktopCustomersPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopCustomersPostRequestBillingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopCustomersPostRequestBillingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopCustomersPostRequestBillingAddress := _QuickbooksDesktopCustomersPostRequestBillingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopCustomersPostRequestBillingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopCustomersPostRequestBillingAddress(varQuickbooksDesktopCustomersPostRequestBillingAddress)
...
type NullableQuickbooksDesktopCustomersPostRequestBillingAddress struct {
	value *QuickbooksDesktopCustomersPostRequestBillingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopCustomersPostRequestBillingAddress) Get() *QuickbooksDesktopCustomersPostRequestBillingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopCustomersPostRequestBillingAddress) Set(val *QuickbooksDesktopCustomersPostRequestBillingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopCustomersPostRequestBillingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopCustomersPostRequestBillingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopCustomersPostRequestBillingAddress(val *QuickbooksDesktopCustomersPostRequestBillingAddress) *NullableQuickbooksDesktopCustomersPostRequestBillingAddress {
	return &NullableQuickbooksDesktopCustomersPostRequestBillingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopCustomersPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopCustomersPostRequestBillingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
