...
// checks if the QuickbooksDesktopInventoryItemsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopInventoryItemsGet200Response{}

// QuickbooksDesktopInventoryItemsGet200Response struct for QuickbooksDesktopInventoryItemsGet200Response
type QuickbooksDesktopInventoryItemsGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of inventory items.
	Data []QbdInventoryItem `json:"data"`
...
type _QuickbooksDesktopInventoryItemsGet200Response QuickbooksDesktopInventoryItemsGet200Response
...
func NewQuickbooksDesktopInventoryItemsGet200Response(objectType string, url string, data []QbdInventoryItem, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopInventoryItemsGet200Response {
	this := QuickbooksDesktopInventoryItemsGet200Response{}
...
func (o QuickbooksDesktopInventoryItemsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopInventoryItemsGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopInventoryItemsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopInventoryItemsGet200Response := _QuickbooksDesktopInventoryItemsGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopInventoryItemsGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopInventoryItemsGet200Response(varQuickbooksDesktopInventoryItemsGet200Response)
...
type NullableQuickbooksDesktopInventoryItemsGet200Response struct {
	value *QuickbooksDesktopInventoryItemsGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopInventoryItemsGet200Response) Get() *QuickbooksDesktopInventoryItemsGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopInventoryItemsGet200Response) Set(val *QuickbooksDesktopInventoryItemsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopInventoryItemsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopInventoryItemsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopInventoryItemsGet200Response(val *QuickbooksDesktopInventoryItemsGet200Response) *NullableQuickbooksDesktopInventoryItemsGet200Response {
	return &NullableQuickbooksDesktopInventoryItemsGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopInventoryItemsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopInventoryItemsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
