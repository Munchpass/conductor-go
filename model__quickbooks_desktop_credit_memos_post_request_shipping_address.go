...
// checks if the QuickbooksDesktopCreditMemosPostRequestShippingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopCreditMemosPostRequestShippingAddress{}

// QuickbooksDesktopCreditMemosPostRequestShippingAddress The credit memo's shipping address.
type QuickbooksDesktopCreditMemosPostRequestShippingAddress struct {
...
type _QuickbooksDesktopCreditMemosPostRequestShippingAddress QuickbooksDesktopCreditMemosPostRequestShippingAddress
...
func NewQuickbooksDesktopCreditMemosPostRequestShippingAddress() *QuickbooksDesktopCreditMemosPostRequestShippingAddress {
	this := QuickbooksDesktopCreditMemosPostRequestShippingAddress{}
	return &this
}
...
func (o QuickbooksDesktopCreditMemosPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopCreditMemosPostRequestShippingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopCreditMemosPostRequestShippingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopCreditMemosPostRequestShippingAddress := _QuickbooksDesktopCreditMemosPostRequestShippingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopCreditMemosPostRequestShippingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopCreditMemosPostRequestShippingAddress(varQuickbooksDesktopCreditMemosPostRequestShippingAddress)
...
type NullableQuickbooksDesktopCreditMemosPostRequestShippingAddress struct {
	value *QuickbooksDesktopCreditMemosPostRequestShippingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopCreditMemosPostRequestShippingAddress) Get() *QuickbooksDesktopCreditMemosPostRequestShippingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopCreditMemosPostRequestShippingAddress) Set(val *QuickbooksDesktopCreditMemosPostRequestShippingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopCreditMemosPostRequestShippingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopCreditMemosPostRequestShippingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopCreditMemosPostRequestShippingAddress(val *QuickbooksDesktopCreditMemosPostRequestShippingAddress) *NullableQuickbooksDesktopCreditMemosPostRequestShippingAddress {
	return &NullableQuickbooksDesktopCreditMemosPostRequestShippingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopCreditMemosPostRequestShippingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopCreditMemosPostRequestShippingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
