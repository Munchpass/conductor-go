...
// checks if the QuickbooksDesktopVendorCreditsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopVendorCreditsGet200Response{}

// QuickbooksDesktopVendorCreditsGet200Response struct for QuickbooksDesktopVendorCreditsGet200Response
type QuickbooksDesktopVendorCreditsGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of vendor credits.
	Data []QbdVendorCredit `json:"data"`
...
type _QuickbooksDesktopVendorCreditsGet200Response QuickbooksDesktopVendorCreditsGet200Response
...
func NewQuickbooksDesktopVendorCreditsGet200Response(objectType string, url string, data []QbdVendorCredit, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopVendorCreditsGet200Response {
	this := QuickbooksDesktopVendorCreditsGet200Response{}
...
func (o QuickbooksDesktopVendorCreditsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopVendorCreditsGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopVendorCreditsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopVendorCreditsGet200Response := _QuickbooksDesktopVendorCreditsGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopVendorCreditsGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopVendorCreditsGet200Response(varQuickbooksDesktopVendorCreditsGet200Response)
...
type NullableQuickbooksDesktopVendorCreditsGet200Response struct {
	value *QuickbooksDesktopVendorCreditsGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopVendorCreditsGet200Response) Get() *QuickbooksDesktopVendorCreditsGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopVendorCreditsGet200Response) Set(val *QuickbooksDesktopVendorCreditsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopVendorCreditsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopVendorCreditsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopVendorCreditsGet200Response(val *QuickbooksDesktopVendorCreditsGet200Response) *NullableQuickbooksDesktopVendorCreditsGet200Response {
	return &NullableQuickbooksDesktopVendorCreditsGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopVendorCreditsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopVendorCreditsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
