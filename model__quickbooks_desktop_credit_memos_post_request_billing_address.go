...
// checks if the QuickbooksDesktopCreditMemosPostRequestBillingAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopCreditMemosPostRequestBillingAddress{}

// QuickbooksDesktopCreditMemosPostRequestBillingAddress The credit memo's billing address.
type QuickbooksDesktopCreditMemosPostRequestBillingAddress struct {
...
type _QuickbooksDesktopCreditMemosPostRequestBillingAddress QuickbooksDesktopCreditMemosPostRequestBillingAddress
...
func NewQuickbooksDesktopCreditMemosPostRequestBillingAddress() *QuickbooksDesktopCreditMemosPostRequestBillingAddress {
	this := QuickbooksDesktopCreditMemosPostRequestBillingAddress{}
	return &this
}
...
func (o QuickbooksDesktopCreditMemosPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopCreditMemosPostRequestBillingAddress) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopCreditMemosPostRequestBillingAddress) UnmarshalJSON(data []byte) (err error) {
	varQuickbooksDesktopCreditMemosPostRequestBillingAddress := _QuickbooksDesktopCreditMemosPostRequestBillingAddress{}

	err = json.Unmarshal(data, &varQuickbooksDesktopCreditMemosPostRequestBillingAddress)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopCreditMemosPostRequestBillingAddress(varQuickbooksDesktopCreditMemosPostRequestBillingAddress)
...
type NullableQuickbooksDesktopCreditMemosPostRequestBillingAddress struct {
	value *QuickbooksDesktopCreditMemosPostRequestBillingAddress
	isSet bool
}

func (v NullableQuickbooksDesktopCreditMemosPostRequestBillingAddress) Get() *QuickbooksDesktopCreditMemosPostRequestBillingAddress {
	return v.value
}

func (v *NullableQuickbooksDesktopCreditMemosPostRequestBillingAddress) Set(val *QuickbooksDesktopCreditMemosPostRequestBillingAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopCreditMemosPostRequestBillingAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopCreditMemosPostRequestBillingAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopCreditMemosPostRequestBillingAddress(val *QuickbooksDesktopCreditMemosPostRequestBillingAddress) *NullableQuickbooksDesktopCreditMemosPostRequestBillingAddress {
	return &NullableQuickbooksDesktopCreditMemosPostRequestBillingAddress{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopCreditMemosPostRequestBillingAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopCreditMemosPostRequestBillingAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
