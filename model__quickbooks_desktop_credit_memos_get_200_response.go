...
// checks if the QuickbooksDesktopCreditMemosGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopCreditMemosGet200Response{}

// QuickbooksDesktopCreditMemosGet200Response struct for QuickbooksDesktopCreditMemosGet200Response
type QuickbooksDesktopCreditMemosGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of credit memos.
	Data []QbdCreditMemo `json:"data"`
...
type _QuickbooksDesktopCreditMemosGet200Response QuickbooksDesktopCreditMemosGet200Response
...
func NewQuickbooksDesktopCreditMemosGet200Response(objectType string, url string, data []QbdCreditMemo, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopCreditMemosGet200Response {
	this := QuickbooksDesktopCreditMemosGet200Response{}
...
func (o QuickbooksDesktopCreditMemosGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopCreditMemosGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopCreditMemosGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopCreditMemosGet200Response := _QuickbooksDesktopCreditMemosGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopCreditMemosGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopCreditMemosGet200Response(varQuickbooksDesktopCreditMemosGet200Response)
...
type NullableQuickbooksDesktopCreditMemosGet200Response struct {
	value *QuickbooksDesktopCreditMemosGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopCreditMemosGet200Response) Get() *QuickbooksDesktopCreditMemosGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopCreditMemosGet200Response) Set(val *QuickbooksDesktopCreditMemosGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopCreditMemosGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopCreditMemosGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopCreditMemosGet200Response(val *QuickbooksDesktopCreditMemosGet200Response) *NullableQuickbooksDesktopCreditMemosGet200Response {
	return &NullableQuickbooksDesktopCreditMemosGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopCreditMemosGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopCreditMemosGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
