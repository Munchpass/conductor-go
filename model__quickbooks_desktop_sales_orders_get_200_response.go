...
// checks if the QuickbooksDesktopSalesOrdersGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopSalesOrdersGet200Response{}

// QuickbooksDesktopSalesOrdersGet200Response struct for QuickbooksDesktopSalesOrdersGet200Response
type QuickbooksDesktopSalesOrdersGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of sales orders.
	Data []QbdSalesOrder `json:"data"`
...
type _QuickbooksDesktopSalesOrdersGet200Response QuickbooksDesktopSalesOrdersGet200Response
...
func NewQuickbooksDesktopSalesOrdersGet200Response(objectType string, url string, data []QbdSalesOrder, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopSalesOrdersGet200Response {
	this := QuickbooksDesktopSalesOrdersGet200Response{}
...
func (o QuickbooksDesktopSalesOrdersGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopSalesOrdersGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopSalesOrdersGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopSalesOrdersGet200Response := _QuickbooksDesktopSalesOrdersGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopSalesOrdersGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopSalesOrdersGet200Response(varQuickbooksDesktopSalesOrdersGet200Response)
...
type NullableQuickbooksDesktopSalesOrdersGet200Response struct {
	value *QuickbooksDesktopSalesOrdersGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopSalesOrdersGet200Response) Get() *QuickbooksDesktopSalesOrdersGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopSalesOrdersGet200Response) Set(val *QuickbooksDesktopSalesOrdersGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopSalesOrdersGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopSalesOrdersGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopSalesOrdersGet200Response(val *QuickbooksDesktopSalesOrdersGet200Response) *NullableQuickbooksDesktopSalesOrdersGet200Response {
	return &NullableQuickbooksDesktopSalesOrdersGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopSalesOrdersGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopSalesOrdersGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
