...
// checks if the QuickbooksDesktopSubtotalItemsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopSubtotalItemsGet200Response{}

// QuickbooksDesktopSubtotalItemsGet200Response struct for QuickbooksDesktopSubtotalItemsGet200Response
type QuickbooksDesktopSubtotalItemsGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of subtotal items.
	Data []QbdSubtotalItem `json:"data"`
...
type _QuickbooksDesktopSubtotalItemsGet200Response QuickbooksDesktopSubtotalItemsGet200Response
...
func NewQuickbooksDesktopSubtotalItemsGet200Response(objectType string, url string, data []QbdSubtotalItem, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopSubtotalItemsGet200Response {
	this := QuickbooksDesktopSubtotalItemsGet200Response{}
...
func (o QuickbooksDesktopSubtotalItemsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopSubtotalItemsGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopSubtotalItemsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopSubtotalItemsGet200Response := _QuickbooksDesktopSubtotalItemsGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopSubtotalItemsGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopSubtotalItemsGet200Response(varQuickbooksDesktopSubtotalItemsGet200Response)
...
type NullableQuickbooksDesktopSubtotalItemsGet200Response struct {
	value *QuickbooksDesktopSubtotalItemsGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopSubtotalItemsGet200Response) Get() *QuickbooksDesktopSubtotalItemsGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopSubtotalItemsGet200Response) Set(val *QuickbooksDesktopSubtotalItemsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopSubtotalItemsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopSubtotalItemsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopSubtotalItemsGet200Response(val *QuickbooksDesktopSubtotalItemsGet200Response) *NullableQuickbooksDesktopSubtotalItemsGet200Response {
	return &NullableQuickbooksDesktopSubtotalItemsGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopSubtotalItemsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopSubtotalItemsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
