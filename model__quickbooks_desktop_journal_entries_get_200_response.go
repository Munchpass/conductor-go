...
// checks if the QuickbooksDesktopJournalEntriesGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickbooksDesktopJournalEntriesGet200Response{}

// QuickbooksDesktopJournalEntriesGet200Response struct for QuickbooksDesktopJournalEntriesGet200Response
type QuickbooksDesktopJournalEntriesGet200Response struct {
	// The type of object. This value is always `\"list\"`.
	ObjectType string `json:"objectType"`
	// The endpoint URL where this list can be accessed.
	Url string `json:"url"`
	// The array of journal entries.
	Data []QbdJournalEntry `json:"data"`
...
type _QuickbooksDesktopJournalEntriesGet200Response QuickbooksDesktopJournalEntriesGet200Response
...
func NewQuickbooksDesktopJournalEntriesGet200Response(objectType string, url string, data []QbdJournalEntry, nextCursor string, remainingCount float32, hasMore bool) *QuickbooksDesktopJournalEntriesGet200Response {
	this := QuickbooksDesktopJournalEntriesGet200Response{}
...
func (o QuickbooksDesktopJournalEntriesGet200Response) MarshalJSON() ([]byte, error) {
...
func (o QuickbooksDesktopJournalEntriesGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuickbooksDesktopJournalEntriesGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickbooksDesktopJournalEntriesGet200Response := _QuickbooksDesktopJournalEntriesGet200Response{}

	err = json.Unmarshal(data, &varQuickbooksDesktopJournalEntriesGet200Response)

	if err != nil {
		return err
	}

	*o = QuickbooksDesktopJournalEntriesGet200Response(varQuickbooksDesktopJournalEntriesGet200Response)
...
type NullableQuickbooksDesktopJournalEntriesGet200Response struct {
	value *QuickbooksDesktopJournalEntriesGet200Response
	isSet bool
}

func (v NullableQuickbooksDesktopJournalEntriesGet200Response) Get() *QuickbooksDesktopJournalEntriesGet200Response {
	return v.value
}

func (v *NullableQuickbooksDesktopJournalEntriesGet200Response) Set(val *QuickbooksDesktopJournalEntriesGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickbooksDesktopJournalEntriesGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickbooksDesktopJournalEntriesGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickbooksDesktopJournalEntriesGet200Response(val *QuickbooksDesktopJournalEntriesGet200Response) *NullableQuickbooksDesktopJournalEntriesGet200Response {
	return &NullableQuickbooksDesktopJournalEntriesGet200Response{value: val, isSet: true}
}

func (v NullableQuickbooksDesktopJournalEntriesGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickbooksDesktopJournalEntriesGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
