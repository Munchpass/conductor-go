...
// checks if the QbdCreditCardCharge type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QbdCreditCardCharge{}

// QbdCreditCardCharge struct for QbdCreditCardCharge
type QbdCreditCardCharge struct {
	...
	Account QbdCreditCardChargeAccount `json:"account"`
	Payee QbdCreditCardChargePayee `json:"payee"`
	...
	Currency QbdCreditCardChargeCurrency `json:"currency"`
	...
	SalesTaxCode QbdCreditCardChargeSalesTaxCode `json:"salesTaxCode"`
...
type _QbdCreditCardCharge QbdCreditCardCharge
...
func (o *QbdCreditCardCharge) GetAccount() QbdCreditCardChargeAccount {
	if o == nil {
		var ret QbdCreditCardChargeAccount
		return ret
	}
...
func (o *QbdCreditCardCharge) GetPayee() QbdCreditCardChargePayee {
	if o == nil {
		var ret QbdCreditCardChargePayee
		return ret
	}
...
func (o *QbdCreditCardCharge) GetCurrency() QbdCreditCardChargeCurrency {
	if o == nil {
		var ret QbdCreditCardChargeCurrency
		return ret
	}
...
func (o *QbdCreditCardCharge) GetSalesTaxCode() QbdCreditCardChargeSalesTaxCode {
	if o == nil {
		var ret QbdCreditCardChargeSalesTaxCode
		return ret
	}
...
func (o QbdCreditCardCharge) MarshalJSON() ([]byte, error) {
...
func (o QbdCreditCardCharge) ToMap() (map[string]interface{}, error) {
...
func (o *QbdCreditCardCharge) UnmarshalJSON(data []byte) (err error) {
	...
	varQbdCreditCardCharge := _QbdCreditCardCharge{}

	err = json.Unmarshal(data, &varQbdCreditCardCharge)

	if err != nil {
		return err
	}

	*o = QbdCreditCardCharge(varQbdCreditCardCharge)
...
type NullableQbdCreditCardCharge struct {
	value *QbdCreditCardCharge
	isSet bool
}

func (v NullableQbdCreditCardCharge) Get() *QbdCreditCardCharge {
	return v.value
}

func (v *NullableQbdCreditCardCharge) Set(val *QbdCreditCardCharge) {
	v.value = val
	v.isSet = true
}

func (v NullableQbdCreditCardCharge) IsSet() bool {
	return v.isSet
}

func (v *NullableQbdCreditCardCharge) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQbdCreditCardCharge(val *QbdCreditCardCharge) *NullableQbdCreditCardCharge {
	return &NullableQbdCreditCardCharge{value: val, isSet: true}
}

func (v NullableQbdCreditCardCharge) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQbdCreditCardCharge) UnmarshalJSON(src []byte) error {
	v.isSet = true
